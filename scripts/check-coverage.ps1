...
Write-Host 'Coverage descriptor gate passed: all 69 reachable success arms are explicitly classified; 7 composition carriers require coverage; 62 non-composition arms select one of 3 closed reasons.'
exit 0
