...
Write-Host 'Coverage descriptor gate passed: all 67 reachable success arms are explicitly classified; 4 composition carriers require CoverageDeclaration; 63 non-composition arms select one of 3 closed reasons.'
exit 0
