...
- **R9G 当前状态（2026-09-05）：** 不可变 tag `v0.1.0-alpha.11` 已推送；[版本 CI](https://github.com/kayz/ficant/actions/runs/33933106201) 的 11 个 job 中 9 个成功、Rust 与 Web 失败，[release-test](https://github.com/kayz/ficant/actions/runs/33934227298) 7/7 jobs skipped 且 artifact 为 0，三类应用镜像没有此次 SHA/版本标签，test environment deployments 为空。没有登录测试机、执行 migration、部署、健康/烟测或回滚。R9G forward-only 修复已通过 [PR #73](https://github.com/kayz/ficant/pull/73) 合入公共 `main@811a7062e25af41df1316d2c883914a00c5142ed`（tree `34cba6a4afb1bd2440211ea3342c82a73d41c6af`）；双平台定向测试、真实 gRPC-Web smoke/快速失败、23/23 快速检查、40/40 标准检查、无 finding 独立复审及合入后的 17/17 步 clean-main preflight 均通过。`alpha.11` 保持原位且不重跑，后续部署仍须由 Human 明确授权新的 forward-only 版本，详见 [R9G brief](../iterations/2026-09-r9g-linux-release-parity.md)。
