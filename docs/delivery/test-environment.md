...
- **R9G 当前状态（2026-09-05）：** R9F 已通过 [PR #71](https://github.com/kayz/ficant/pull/71) 合入，公共 `main@791555b22b6ef8c847622621c860a8789ba9e32d`（tree `fc723187bf4421fde0b71165f239b98dd311db77`）通过 17/17 步 clean-main preflight。不可变 tag `v0.1.0-alpha.11` 已推送；[版本 CI](https://github.com/kayz/ficant/actions/runs/33933106201) 的 11 个 job 中 9 个成功、Rust 与 Web 失败，[release-test](https://github.com/kayz/ficant/actions/runs/33934227298) 7/7 jobs skipped 且 artifact 为 0，三类应用镜像没有此次 SHA/版本标签，test environment deployments 为空。没有登录测试机、执行 migration、部署、健康/烟测或回滚。R9G 本地可执行候选 `cd8e64e5b2912147cf4a24cc4247ebbdb4fe82b0` 已通过双平台定向测试、真实 gRPC-Web smoke/快速失败、23/23 快速检查、40/40 标准检查和无 finding 独立复审，待 PR 合入与 clean-main preflight；`alpha.11` 保持原位且不重跑，后续部署仍须由 Human 选择新的 forward-only 版本，详见 [R9G brief](../iterations/2026-09-r9g-linux-release-parity.md)。
